...
import (
	...
	"github.com/GriubCoin-Network/GriubCoin/client/erc20"
	"github.com/GriubCoin-Network/GriubCoin/tests/e2e/runner"
	"github.com/GriubCoin-Network/GriubCoin/tests/e2e/testutil"
	kavainterchain "github.com/GriubCoin-Network/GriubCoin/tests/interchain"
...
func TestInterchainErc20(t *testing.T) {
	...
	cf := interchaintest.NewBuiltinChainFactory(zaptest.NewLogger(t), []*interchaintest.ChainSpec{
		{Name: "grbc", ChainConfig: kavainterchain.DefaultKavaChainConfig(kavainterchain.KavaTestChainId)},
	...
	user := kava.NewFundedAccount("tether-user", sdk.NewCoins(sdk.NewCoin("ugrbc", math.NewInt(1e7))))
	...
	convertTx := util.KavaMsgRequest{
		Msgs:      []sdk.Msg{&msg},
		GasLimit:  4e5,
		FeeAmount: sdk.NewCoins(sdk.NewCoin("ugrbc", sdk.NewInt(400))),
