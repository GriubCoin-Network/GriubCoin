	...
	balances := []banktypes.Balance{
		{
			...
			Coins:   sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(100000000000000))),
		},
	}
...
func genesisStateWithValSet(
	...
	currentStakingGenesis.Params.BondDenom = "ugrbc"
	...
	for range delegations {
		...
		totalSupply = totalSupply.Add(sdk.NewCoin("ugrbc", bondAmt))
	}

	// add bonded amount to bonded pool module account
	balances = append(balances, banktypes.Balance{
		Address: authtypes.NewModuleAddress(stakingtypes.BondedPoolName).String(),
		Coins:   sdk.Coins{sdk.NewCoin("ugrbc", bondAmt)},
	})
