...
import (
	...
	v015swap "github.com/GriubCoin-Network/GriubCoin/x/swap/legacy/v0_15"
	v016swap "github.com/GriubCoin-Network/GriubCoin/x/swap/types"
)
...
func (s *migrateTestSuite) TestMigrate_PoolRecords() {
	s.v15genstate.PoolRecords = v015swap.PoolRecords{
		...
		},
		{
			...
			ReservesB:   sdk.NewCoin("ugrbc", sdkmath.NewInt(500)),
