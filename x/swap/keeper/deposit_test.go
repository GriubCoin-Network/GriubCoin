...
func (suite *keeperTestSuite) TestDeposit_CreatePool_PoolNotAllowed() {
	...
	amountA := sdk.NewCoin("ugrbc", sdkmath.NewInt(10e6))
	...
	suite.Require().EqualError(err, "can not create pool 'ugrbc:usdx': not allowed")
}
...
func (suite *keeperTestSuite) TestDeposit_InsufficientFunds() {
	testCases := []struct {
	...
	}{
		{
			...
			depositA: sdk.NewCoin("ugrbc", sdkmath.NewInt(100)),
			depositB: sdk.NewCoin("usdx", sdkmath.NewInt(100)),
		},
		{
			name:     "low balance",
			balanceA: sdk.NewCoin("ugrbc", sdkmath.NewInt(1000000)),
			balanceB: sdk.NewCoin("usdx", sdkmath.NewInt(1000000)),
			depositA: sdk.NewCoin("ugrbc", sdkmath.NewInt(1000001)),
			depositB: sdk.NewCoin("usdx", sdkmath.NewInt(10000001)),
		},
		{
			name:     "large balance difference",
			balanceA: sdk.NewCoin("ugrbc", sdkmath.NewInt(100e6)),
			balanceB: sdk.NewCoin("usdx", sdkmath.NewInt(500e6)),
			depositA: sdk.NewCoin("ugrbc", sdkmath.NewInt(1000e6)),
	...
	for _, tc := range testCases {
		suite.Run(tc.name, func() {
			...
			err = suite.CreatePool(sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(10e6)), sdk.NewCoin("usdx", sdkmath.NewInt(50e6))))
...
func (suite *keeperTestSuite) TestDeposit_InsufficientFunds_Vesting() {
	testCases := []struct {
	...
	}{
		{
			...
			balanceA: sdk.NewCoin("ugrbc", sdk.ZeroInt()),
			balanceB: sdk.NewCoin("usdx", sdk.ZeroInt()),
			vestingA: sdk.NewCoin("ugrbc", sdkmath.NewInt(100)),
		...
		},
		{
			...
			balanceA: sdk.NewCoin("ugrbc", sdkmath.NewInt(1000000)),
			balanceB: sdk.NewCoin("usdx", sdkmath.NewInt(1000000)),
			vestingA: sdk.NewCoin("ugrbc", sdkmath.NewInt(1)),
		...
		},
		{
			...
			balanceA: sdk.NewCoin("ugrbc", sdkmath.NewInt(100e6)),
			balanceB: sdk.NewCoin("usdx", sdkmath.NewInt(500e6)),
			vestingA: sdk.NewCoin("ugrbc", sdkmath.NewInt(1000e6)),
...
func (suite *keeperTestSuite) TestDeposit_CreatePool() {
	pool := types.NewAllowedPool("ugrbc", "usdx")
	suite.Require().NoError(pool.Validate())
	suite.Keeper.SetParams(suite.Ctx, types.NewParams(types.NewAllowedPools(pool), types.DefaultSwapFee))
...
func (suite *keeperTestSuite) TestDeposit_PoolExists() {
	...
	balance := sdk.NewCoins(
		sdk.NewCoin("ugrbc", sdkmath.NewInt(5e6)),
	...
	depositB := sdk.NewCoin("ugrbc", balance.AmountOf("ugrbc"))
	...
	expectedShareValue := sdk.NewCoins(
		sdk.NewCoin("ugrbc", sdkmath.NewInt(999999)),
...
func (suite *keeperTestSuite) TestDeposit_MultipleDeposit() {
	...
	depositB := sdk.NewCoin("ugrbc", fundsToDeposit.AmountOf("ugrbc"))
...
func (suite *keeperTestSuite) TestDeposit_Slippage() {
	...
	testCases := []struct {
		...
		{sdk.NewCoin("usdx", sdkmath.NewInt(5e6)), sdk.NewCoin("ugrbc", sdkmath.NewInt(5e6)), sdk.MustNewDecFromStr("0.7"), true},
		{sdk.NewCoin("usdx", sdkmath.NewInt(5e6)), sdk.NewCoin("ugrbc", sdkmath.NewInt(5e6)), sdk.MustNewDecFromStr("0.8"), true},
		{sdk.NewCoin("ugrbc", sdkmath.NewInt(5e6)), sdk.NewCoin("usdx", sdkmath.NewInt(5e6)), sdk.MustNewDecFromStr("3"), true},
		{sdk.NewCoin("ugrbc", sdkmath.NewInt(5e6)), sdk.NewCoin("usdx", sdkmath.NewInt(5e6)), sdk.MustNewDecFromStr("4"), false},
		{sdk.NewCoin("ugrbc", sdkmath.NewInt(1e6)), sdk.NewCoin("usdx", sdkmath.NewInt(5e6)), sdk.MustNewDecFromStr("0"), false},
		{sdk.NewCoin("ugrbc", sdkmath.NewInt(1e6)), sdk.NewCoin("usdx", sdkmath.NewInt(4e6)), sdk.MustNewDecFromStr("0.25"), false},
		{sdk.NewCoin("ugrbc", sdkmath.NewInt(1e6)), sdk.NewCoin("usdx", sdkmath.NewInt(4e6)), sdk.MustNewDecFromStr("0.2"), true},
	}
...
func (suite *keeperTestSuite) TestDeposit_InsufficientLiquidity() {
	testCases := []struct {
		...
		{sdk.NewCoin("ugrbc", sdkmath.NewInt(10e6)), sdk.NewCoin("usdx", sdkmath.NewInt(50e6)), sdkmath.NewInt(40e6), sdk.NewCoin("ugrbc", sdkmath.NewInt(1)), sdk.NewCoin("usdx", sdkmath.NewInt(1))},
		// test share value rounding to zero
		{sdk.NewCoin("ugrbc", sdkmath.NewInt(10e6)), sdk.NewCoin("usdx", sdkmath.NewInt(10e6)), sdkmath.NewInt(100), sdk.NewCoin("ugrbc", sdkmath.NewInt(1000)), sdk.NewCoin("usdx", sdkmath.NewInt(1000))},
	}
