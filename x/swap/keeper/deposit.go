...
//
// For example, if we have a pool with 100e6 ugrbc and 400e6 usdx.  The ugrbc price is 4 usdx and the
// usdx price is 0.25 ugrbc.  If a depositor adds liquidity of 4e6 ugrbc and 14e6 usdx, a kava price of
// 3.50 usdx and a usdx price of 0.29 ugrbc.  This is a -12.5% slippage is the ugrbc price, and a 14.3%
