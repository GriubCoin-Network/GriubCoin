...
func (suite *keeperTestSuite) TestWithdraw_PartialShares() {
	...
	minCoinB := sdk.NewCoin("ugrbc", sdkmath.NewInt(5e6))
...
func (suite *keeperTestSuite) TestWithdraw_MinWithdraw() {
	...
	testCases := []struct {
		...
		{sdkmath.NewInt(1), sdk.NewCoin("ugrbc", sdkmath.NewInt(1)), sdk.NewCoin("usdx", sdkmath.NewInt(1)), true},
		{sdkmath.NewInt(1), sdk.NewCoin("usdx", sdkmath.NewInt(5)), sdk.NewCoin("ugrbc", sdkmath.NewInt(1)), true},

		{sdkmath.NewInt(2), sdk.NewCoin("ugrbc", sdkmath.NewInt(1)), sdk.NewCoin("usdx", sdkmath.NewInt(1)), true},
		{sdkmath.NewInt(2), sdk.NewCoin("usdx", sdkmath.NewInt(5)), sdk.NewCoin("ugrbc", sdkmath.NewInt(1)), true},

		{sdkmath.NewInt(3), sdk.NewCoin("ugrbc", sdkmath.NewInt(1)), sdk.NewCoin("usdx", sdkmath.NewInt(5)), false},
		{sdkmath.NewInt(3), sdk.NewCoin("usdx", sdkmath.NewInt(5)), sdk.NewCoin("ugrbc", sdkmath.NewInt(1)), false},
	}
...
func (suite *keeperTestSuite) TestWithdraw_BelowMinimum() {
	...
	testCases := []struct {
		...
		{sdkmath.NewInt(15e6), sdk.NewCoin("ugrbc", sdkmath.NewInt(5000001)), sdk.NewCoin("usdx", sdkmath.NewInt(25e6)), true},
	}
...
func (suite *keeperTestSuite) TestWithdraw_PanicOnMissingPool() {
	...
	suite.PanicsWithValue("pool ugrbc:usdx not found", func() {
