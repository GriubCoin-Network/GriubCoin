...
func (suite *keeperTestSuite) TestPool_PanicsWhenInvalid() {
	invalidRecord := types.NewPoolRecord(
		sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(100e6)), sdk.NewCoin("usdx", sdkmath.NewInt(100e6))),
		i(-1),
	)
...
func (suite *keeperTestSuite) TestHooks() {
	...
	suite.Keeper.AfterPoolDepositCreated(suite.Ctx, "ugrbc/usdx", depositor, sdkmath.NewInt(1e6))
	suite.Keeper.BeforePoolDepositModified(suite.Ctx, "ugrbc/usdx", depositor, sdkmath.NewInt(1e6))
	...
	swapHooks.On("AfterPoolDepositCreated", suite.Ctx, "ugrbc/usdx", depositor, sdkmath.NewInt(1e6)).Once()
	suite.Keeper.AfterPoolDepositCreated(suite.Ctx, "ugrbc/usdx", depositor, sdkmath.NewInt(1e6))
	swapHooks.On("BeforePoolDepositModified", suite.Ctx, "ugrbc/usdx", depositor, sdkmath.NewInt(1e6)).Once()
	suite.Keeper.BeforePoolDepositModified(suite.Ctx, "ugrbc/usdx", depositor, sdkmath.NewInt(1e6))
