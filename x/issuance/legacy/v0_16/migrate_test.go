...
import (
	...
	v015issuance "github.com/GriubCoin-Network/GriubCoin/x/issuance/legacy/v0_15"
	v016issuance "github.com/GriubCoin-Network/GriubCoin/x/issuance/types"
)
...
func (s *migrateTestSuite) TestMigrate_JSON() {
	...
	data := `{
		...
		"supplies": [
			{
				"current_supply": { "denom": "ugrbc", "amount": "100" },
...
func (s *migrateTestSuite) TestMigrate_Supplies() {
	s.v15genstate.Supplies = v015issuance.AssetSupplies{
		{
			CurrentSupply: sdk.NewCoin("ugrbc", sdkmath.NewInt(100)),
