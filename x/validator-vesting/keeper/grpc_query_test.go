...
import (
	...
	"github.com/GriubCoin-Network/GriubCoin/x/validator-vesting/keeper"
	"github.com/GriubCoin-Network/GriubCoin/x/validator-vesting/types"
)
...
func (suite *grpcQueryTestSuite) TestCirculatingSupply() {
	suite.Run("vesting period supply", func() {
		suite.bk.SetSupply(suite.ctx, "ugrbc", sdkmath.NewInt(2_500_000_000_000))
	...
	suite.Run("supply after last vesting period", func() {
		suite.bk.SetSupply(suite.ctx, "ugrbc", sdkmath.NewInt(100_000_000))
