...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"grbc", "incentive", "v1beta1", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Rewards_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"grbc", "incentive", "v1beta1", "rewards"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_RewardFactors_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"grbc", "incentive", "v1beta1", "reward_factors"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Apy_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"grbc", "incentive", "v1beta1", "apy"}, "", runtime.AssumeColonVerbOpt(false)))
)
