	...
	testCases := []test{
		...
		},
		{
			...
			args{
				...
				expectedRewardIndexes: types.RewardIndexes{
					...
					types.NewRewardIndex("ugrbc", d("0.000000856478000000")),
				},
			},
		},
		{
			...
			args{
				...
				expectedRewardIndexes: types.RewardIndexes{
					...
					types.NewRewardIndex("ugrbc", d("0.010571385600000000")),
				},
			},
		},
		{
		...
		},
		{
			...
			args{
				...
				expectedRewardIndexes: types.RewardIndexes{
					types.NewRewardIndex("hard", d("0.010571385600000000")),
					types.NewRewardIndex("ugrbc", d("0.047999952000000000")),
				},
			},
		},
	}
...
func (suite *SupplyRewardsTestSuite) TestSynchronizeHardSupplyReward() {
	...
	testCases := []test{
		...
		},
		{
			...
			args{
				incentiveSupplyRewardDenom: "ugrbc",
				deposit:                    c("ugrbc", 1),
				rewardsPerSecond:           cs(c("hard", 122354)),
				blockTimes:                 []int{10, 10, 10, 10, 10, 10, 10, 10, 10, 10},
		...
		},
		{
			...
			args{
				...
				expectedRewardIndexes: types.RewardIndexes{
					...
					types.NewRewardIndex("ugrbc", d("0.001223540000000000")),
				},
		...
		},
		{
			...
			args{
				...
				expectedRewardIndexes: types.RewardIndexes{
					...
					types.NewRewardIndex("ugrbc", d("10.571385600000000000")),
				},
				expectedRewards:            cs(c("hard", 105713856000), c("ugrbc", 105713856000)),
				updateRewardsViaCommmittee: false,
			},
		},
		{
			...
			args{
				...
				expectedRewardIndexes: types.RewardIndexes{
					types.NewRewardIndex("hard", d("0.001223540000000000")),
					types.NewRewardIndex("ugrbc", d("0.005555550000000000")),
				},
		...
		},
		{
			...
			args{
				...
				updatedExpectedRewards:     cs(c("hard", 21142771200), c("ugrbc", 8640000000)),
				updatedExpectedRewardIndexes: types.RewardIndexes{
					types.NewRewardIndex("hard", d("2.114277120000000000")),
					types.NewRewardIndex("ugrbc", d("0.864000000000000000")),
				},
		...
		},
		{
			...
			args{
				...
				updatedExpectedRewards:     cs(c("hard", 8640000000), c("ugrbc", 8683200000), c("swap", 43200000)),
				updatedExpectedRewardIndexes: types.RewardIndexes{
					types.NewRewardIndex("hard", d("0.864")),
					types.NewRewardIndex("ugrbc", d("0.86832")),
	...
	for _, tc := range testCases {
		suite.Run(tc.name, func() {
			...
			suite.Require().NoError(
				suite.hardKeeper.Deposit(suite.ctx, suite.addrs[2], cs(c("ugrbc", 100_000_000))),
			)
	...
	testCases := []test{
		{
			...
			args{
				...
				modification:              depositModification{coins: cs(c("ugrbc", 10000000000))},
				rewardsPerSecond:          cs(c("hard", 122354)),
				expectedSupplyIndexDenoms: []string{"bnb", "ugrbc"},
			},
		},
		{
			...
			args{
				firstDeposit:              cs(c("bnb", 10000000000)),
				modification:              depositModification{coins: cs(c("ugrbc", 10000000000), c("btcb", 10000000000), c("xrp", 10000000000))},
				rewardsPerSecond:          cs(c("hard", 122354)),
				expectedSupplyIndexDenoms: []string{"bnb", "ugrbc", "btcb", "xrp"},
			},
		},
		{
		...
		},
		{
			...
			args{
				firstDeposit:              cs(c("bnb", 1000000000), c("ugrbc", 100000000)),
				modification:              depositModification{coins: cs(c("bnb", 1100000000)), withdraw: true},
				rewardsPerSecond:          cs(c("hard", 122354)),
				expectedSupplyIndexDenoms: []string{"ugrbc"},
			},
		},
		{
	...
	for _, tc := range testCases {
		suite.Run(tc.name, func() {
			...
			incentBuilder := testutil.NewIncentiveGenesisBuilder().
				...
				WithSimpleSupplyRewardPeriod("ugrbc", tc.args.rewardsPerSecond).
