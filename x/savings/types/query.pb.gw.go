...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"grbc", "savings", "v1beta1", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Deposits_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"grbc", "savings", "v1beta1", "deposits"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_TotalSupply_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"grbc", "savings", "v1beta1", "total_supply"}, "", runtime.AssumeColonVerbOpt(false)))
)
