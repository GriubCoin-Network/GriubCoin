...
import (
	...
	app "github.com/GriubCoin-Network/GriubCoin/app"
	v015hard "github.com/GriubCoin-Network/GriubCoin/x/hard/legacy/v0_15"
	v016hard "github.com/GriubCoin-Network/GriubCoin/x/hard/types"
)
...
func (s *migrateTestSuite) TestMigrate_GenState() {
	v15genstate := v015hard.GenesisState{
		...
		Deposits: v015hard.Deposits{
			{
				...
				Amount:    sdk.NewCoins(sdk.NewCoin("grbc", sdkmath.NewInt(100))),
		...
		TotalSupplied: sdk.NewCoins(sdk.NewCoin("grbc", sdkmath.NewInt(100))),
