...
import (
	...
	auctiontypes "github.com/GriubCoin-Network/GriubCoin/x/auction/types"
	"github.com/GriubCoin-Network/GriubCoin/x/hard"
	"github.com/GriubCoin-Network/GriubCoin/x/hard/types"
	pricefeedtypes "github.com/GriubCoin-Network/GriubCoin/x/pricefeed/types"
)
	...
	testCases := []liqTest{
		{
			...
			args{
				...
				initialModuleCoins:         sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(100*KAVA_CF))),
				initialBorrowerCoins:       sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(100*KAVA_CF))),
				initialKeeperCoins:         sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(100*KAVA_CF))),
				depositCoins:               sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(10*KAVA_CF))),
				borrowCoins:                sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(8*KAVA_CF))),
				liquidateAfter:             oneMonthDur,
				expectedTotalSuppliedCoins: sdk.NewCoins(sdk.NewInt64Coin("ugrbc", 100004118)),
				expectedTotalBorrowedCoins: nil,
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(100500020))),
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(98000001))), // initial - deposit + borrow + liquidation leftovers
				expectedAuctions: []auctiontypes.Auction{
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              1,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("ugrbc", 9500390),
							Bidder:          sdk.AccAddress(nil),
							Bid:             sdk.NewInt64Coin("ugrbc", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
							MaxEndTime:      endTime,
						},
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("ugrbc", 8004766),
		...
		},
		{
			...
			args{
				...
				borrowCoins:                sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(8*KAVA_CF))),
				liquidateAfter:             oneMonthDur,
				expectedTotalSuppliedCoins: sdk.NewCoins(sdk.NewInt64Coin("ugrbc", 100_004_117)),
				expectedTotalBorrowedCoins: sdk.NewCoins(sdk.NewInt64Coin("ugrbc", 1)),
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(100*KAVA_CF))),
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(98*KAVA_CF))), // initial - deposit + borrow + liquidation leftovers
				expectedAuctions: []auctiontypes.Auction{
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              1,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("ugrbc", 10000411),
							Bidder:          sdk.AccAddress(nil),
							Bid:             sdk.NewInt64Coin("ugrbc", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
						...
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("ugrbc", 8004765),
						LotReturns:        lotReturns,
					},
				},
			},
		...
		},
		{
			...
			args{
				...
				liquidateAfter:             oneMonthDur,
				expectedTotalSuppliedCoins: sdk.NewCoins(sdk.NewInt64Coin("ugrbc", 100_004_117)),
				expectedTotalBorrowedCoins: sdk.NewCoins(sdk.NewInt64Coin("ugrbc", 8_004_766)),
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(110_000_411))),
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(98*KAVA_CF))), // initial - deposit + borrow + liquidation leftovers
		...
		},
		{
			...
			args{
				...
				keeper:               keeper,
				keeperRewardPercent:  sdk.MustNewDecFromStr("0.05"),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(1000*KAVA_CF)), sdk.NewCoin("usdc", sdkmath.NewInt(1000*KAVA_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(1000*BNB_CF)), sdk.NewCoin("btc", sdkmath.NewInt(1000*BTCB_CF))),
				initialBorrowerCoins: sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(100*KAVA_CF))),
				initialKeeperCoins:   sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(100*KAVA_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(50*KAVA_CF))),                                                                                                                                                 // $100 * 0.8 = $80 borrowable
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("usdc", sdkmath.NewInt(20*KAVA_CF)), sdk.NewCoin("ugrbc", sdkmath.NewInt(10*KAVA_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(2*BNB_CF)), sdk.NewCoin("btc", sdkmath.NewInt(0.2*BTCB_CF))), // $20+$20+$20 = $80 borrowed
				liquidateAfter:       oneMonthDur,
				expectedTotalSuppliedCoins: sdk.NewCoins(
					sdk.NewInt64Coin("ugrbc", 1000000710),
					sdk.NewInt64Coin("usdc", 1000003120),
					sdk.NewInt64Coin("bnb", 100000003123),
					sdk.NewInt64Coin("btc", 100000000031),
				),
				expectedTotalBorrowedCoins: nil,
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(102500001))),
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("usdc", sdkmath.NewInt(20*KAVA_CF)), sdk.NewCoin("ugrbc", sdkmath.NewInt(60000002)), sdk.NewCoin("bnb", sdkmath.NewInt(2*BNB_CF)), sdk.NewCoin("btc", sdkmath.NewInt(0.2*BTCB_CF))), // initial - deposit + borrow + liquidation leftovers
				expectedAuctions: []auctiontypes.Auction{
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              1,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("ugrbc", 11874430),
							Bidder:          sdk.AccAddress(nil),
					...
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              2,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("ugrbc", 11874254),
							Bidder:          sdk.AccAddress(nil),
					...
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              3,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("ugrbc", 11875163),
							Bidder:          sdk.AccAddress(nil),
							Bid:             sdk.NewInt64Coin("ugrbc", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
						...
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("ugrbc", 10000782),
						LotReturns:        lotReturns,
					},
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              4,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("ugrbc", 11876185),
							Bidder:          sdk.AccAddress(nil),
		...
		},
		{
			...
			args{
				...
				keeper:               keeper,
				keeperRewardPercent:  sdk.MustNewDecFromStr("0.05"),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(1000*KAVA_CF))),
				initialBorrowerCoins: sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(100*KAVA_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(100*BNB_CF)), sdk.NewCoin("btc", sdkmath.NewInt(100*BTCB_CF))),
				initialKeeperCoins:   sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(100*KAVA_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(50*KAVA_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(10*BNB_CF)), sdk.NewCoin("btc", sdkmath.NewInt(1*BTCB_CF))), // $100 + $100 + $100 = $300 * 0.8 = $240 borrowable                                                                                                                                       // $100 * 0.8 = $80 borrowable
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(120*KAVA_CF))),                                                                                              // $240 borrowed
				liquidateAfter:       oneMonthDur,
				expectedTotalSuppliedCoins: sdk.NewCoins(
					sdk.NewInt64Coin("ugrbc", 1000101456),
				),
				expectedTotalBorrowedCoins: nil,
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(102500253)), sdk.NewCoin("bnb", sdkmath.NewInt(0.5*BNB_CF)), sdk.NewCoin("btc", sdkmath.NewInt(0.05*BTCB_CF))), // 5% of each seized coin + initial balances
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(170.000001*KAVA_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(90*BNB_CF)), sdk.NewCoin("btc", sdkmath.NewInt(99*BTCB_CF))),
				expectedAuctions: []auctiontypes.Auction{
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              1,
						...
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("ugrbc", 40036023),
						LotReturns:        lotReturns,
					},
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
					...
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              3,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("ugrbc", 47504818),
							Bidder:          sdk.AccAddress(nil),
							Bid:             sdk.NewInt64Coin("ugrbc", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
						...
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("ugrbc", 40040087),
						LotReturns:        lotReturns,
					},
				},
			},
		...
		},
		{
			...
			args{
				...
				keeper:               keeper,
				keeperRewardPercent:  sdk.MustNewDecFromStr("0.05"),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(1000*KAVA_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(1000*BNB_CF)), sdk.NewCoin("btc", sdkmath.NewInt(1000*BTCB_CF))),
				initialBorrowerCoins: sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(100*KAVA_CF)), sdk.NewCoin("usdc", sdkmath.NewInt(100*KAVA_CF)), sdk.NewCoin("usdt", sdkmath.NewInt(100*KAVA_CF)), sdk.NewCoin("usdx", sdkmath.NewInt(100*KAVA_CF))),
				initialKeeperCoins:   sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(100*KAVA_CF))),
				...
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(35*KAVA_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(10*BNB_CF)), sdk.NewCoin("btc", sdkmath.NewInt(1*BTCB_CF))),       // $270 borrowed
				liquidateAfter:       oneMonthDur,
				expectedTotalSuppliedCoins: sdk.NewCoins(
					sdk.NewInt64Coin("bnb", 100000078047),
					sdk.NewInt64Coin("btc", 100000000780),
					sdk.NewInt64Coin("ugrbc", 1000009550),
					sdk.NewInt64Coin("usdx", 1),
				),
				expectedTotalBorrowedCoins: nil,
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(100*KAVA_CF)), sdk.NewCoin("usdc", sdkmath.NewInt(5*KAVA_CF)), sdk.NewCoin("usdt", sdkmath.NewInt(5*KAVA_CF)), sdk.NewCoin("usdx", sdkmath.NewInt(5*KAVA_CF))), // 5% of each seized coin + initial balances
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(135*KAVA_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(10*BNB_CF)), sdk.NewCoin("btc", sdkmath.NewInt(1*BTCB_CF)), sdk.NewCoin("usdx", sdkmath.NewInt(0.000001*KAVA_CF))),
				expectedAuctions: []auctiontypes.Auction{
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              1,
					...
					&auctiontypes.CollateralAuction{
						...
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("ugrbc", 35010052), // $70.02
						LotReturns:        lotReturns,
					},
				},
			},
		...
		},
		{
			...
			args{
				...
				initialBorrowerCoins:       sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(100*KAVA_CF))),
				initialKeeperCoins:         sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(100*KAVA_CF))),
				depositCoins:               sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(20*KAVA_CF))), // Deposit 20 KAVA
				borrowCoins:                sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(5*KAVA_CF))),  // Borrow 5 KAVA
				liquidateAfter:             oneMonthDur,
				expectedTotalSuppliedCoins: sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(120001624))),
				expectedTotalBorrowedCoins: sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(5001709))),
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(100.5*KAVA_CF))),
			...
			pricefeedGS := pricefeedtypes.GenesisState{
				Params: pricefeedtypes.Params{
					Markets: []pricefeedtypes.Market{
						...
						{MarketID: "kava:usd", BaseAsset: "grbc", QuoteAsset: "usd", Oracles: []sdk.AccAddress{}, Active: true},
