	...
	testCases := []borrowTest{
		{
			...
			setup: setupArgs{
				...
				depositCoins:       []sdk.Coin{sdk.NewCoin("ugrbc", sdkmath.NewInt(100*KAVA_CF))},
				initialBorrowCoins: sdk.NewCoins(),
			},
			expected: []expected{
				{
					expectedAccountBalance:    sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(20*KAVA_CF)), sdk.NewCoin("btcb", sdkmath.NewInt(100*BTCB_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(100*BNB_CF)), sdk.NewCoin("xyz", sdkmath.NewInt(1))),
					expectedModAccountBalance: sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(1080*KAVA_CF)), sdk.NewCoin("usdx", sdkmath.NewInt(200*USDX_CF)), sdk.NewCoin("busd", sdkmath.NewInt(100*BUSD_CF))),
			...
			borrows: []borrowArgs{
				{
					borrowCoins: sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(20*KAVA_CF))),
					wantErr:     "",
				},
			},
		},
		{
			...
			setup: setupArgs{
				...
				loanToValueBNB:     sdk.MustNewDecFromStr("0.01"),
				borrower:           sdk.AccAddress(crypto.AddressHash([]byte("test"))),
				depositCoins:       []sdk.Coin{sdk.NewCoin("ugrbc", sdkmath.NewInt(20*KAVA_CF))}, // 20 KAVA x $5.00 price = $100
				initialBorrowCoins: sdk.NewCoins(),
			},
			expected: []expected{
				{
		...
		},
		{
			...
			setup: setupArgs{
				...
				loanToValueBNB:     sdk.MustNewDecFromStr("0.01"),
				borrower:           sdk.AccAddress(crypto.AddressHash([]byte("test"))),
				depositCoins:       sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(50*KAVA_CF)), sdk.NewCoin("btcb", sdkmath.NewInt(0.1*BTCB_CF))),
				initialBorrowCoins: sdk.NewCoins(),
			},
			expected: []expected{
				{
					expectedAccountBalance:    sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(50*KAVA_CF)), sdk.NewCoin("btcb", sdkmath.NewInt(99.9*BTCB_CF)), sdk.NewCoin("usdx", sdkmath.NewInt(180*USDX_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(100*BNB_CF)), sdk.NewCoin("xyz", sdkmath.NewInt(1))),
					expectedModAccountBalance: sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(1050*KAVA_CF)), sdk.NewCoin("usdx", sdkmath.NewInt(20*USDX_CF)), sdk.NewCoin("btcb", sdkmath.NewInt(0.1*BTCB_CF)), sdk.NewCoin("busd", sdkmath.NewInt(100*BUSD_CF))),
		...
		},
		{
			...
			setup: setupArgs{
				...
				borrower:           sdk.AccAddress(crypto.AddressHash([]byte("test"))),
				depositCoins:       sdk.NewCoins(sdk.NewCoin("bnb", sdkmath.NewInt(30*BNB_CF)), sdk.NewCoin("ugrbc", sdkmath.NewInt(50*KAVA_CF))), // (50 KAVA x $2.00 price = $100) + (30 BNB x $5.00 price = $150) = $250
				initialBorrowCoins: sdk.NewCoins(sdk.NewCoin("usdx", sdkmath.NewInt(99*USDX_CF)), sdk.NewCoin("busd", sdkmath.NewInt(100*BUSD_CF))),
			},
			expected: []expected{
				{
					expectedAccountBalance:    sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(50*KAVA_CF)), sdk.NewCoin("btcb", sdkmath.NewInt(100*BTCB_CF)), sdk.NewCoin("usdx", sdkmath.NewInt(100*USDX_CF)), sdk.NewCoin("busd", sdkmath.NewInt(100*BUSD_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(70*BNB_CF)), sdk.NewCoin("xyz", sdkmath.NewInt(1))),
					expectedModAccountBalance: sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(1050*KAVA_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(30*BUSD_CF)), sdk.NewCoin("usdx", sdkmath.NewInt(100*USDX_CF))),
		...
		},
		{
			...
			setup: setupArgs{
				...
				loanToValueBNB:     sdk.MustNewDecFromStr("0.01"),
				borrower:           sdk.AccAddress(crypto.AddressHash([]byte("test"))),
				depositCoins:       sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(100*KAVA_CF))),
				initialBorrowCoins: sdk.NewCoins(),
			},
			expected: []expected{
				{
		...
		},
		{
			...
			setup: setupArgs{
				...
				loanToValueBNB:     sdk.MustNewDecFromStr("0.01"),
				borrower:           sdk.AccAddress(crypto.AddressHash([]byte("test"))),
				depositCoins:       sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(50*KAVA_CF))),
				initialBorrowCoins: sdk.NewCoins(),
			},
			expected: []expected{
				{
		...
		},
		{
			...
			borrows: []borrowArgs{
				{
					borrowCoins: sdk.NewCoins(sdk.NewCoin("usdx", sdkmath.NewInt(5*USDX_CF)), sdk.NewCoin("ugrbc", sdkmath.NewInt(2*USDX_CF))),
					wantErr:     "",
				},
			},
		},
		{
			...
			expected: []expected{
				...
				{
					expectedAccountBalance:    sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(40*KAVA_CF)), sdk.NewCoin("btcb", sdkmath.NewInt(100*BTCB_CF)), sdk.NewCoin("bnb", sdkmath.NewInt(100*BNB_CF)), sdk.NewCoin("xyz", sdkmath.NewInt(1))),
					expectedModAccountBalance: sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(1060*KAVA_CF)), sdk.NewCoin("usdx", sdkmath.NewInt(200*USDX_CF)), sdk.NewCoin("busd", sdkmath.NewInt(100*BUSD_CF))),
					expectPass:                true,
				},
			},
			borrows: []borrowArgs{
		...
		{
			name: "valid borrow followed by protocol reserves exceed available cash for busd when borrowing from ugrbc",
			setup: setupArgs{
				usdxBorrowLimit:    sdk.MustNewDecFromStr("100000000000"),
				priceKAVA:          sdk.MustNewDecFromStr("5.00"),
				loanToValueKAVA:    sdk.MustNewDecFromStr("0.8"),
				...
				loanToValueBNB:     sdk.MustNewDecFromStr("0.8"),
				borrower:           sdk.AccAddress(crypto.AddressHash([]byte("test"))),
				depositCoins:       sdk.NewCoins(sdk.NewCoin("bnb", sdkmath.NewInt(30*BNB_CF)), sdk.NewCoin("ugrbc", sdkmath.NewInt(50*KAVA_CF))),
				initialBorrowCoins: sdk.NewCoins(sdk.NewCoin("usdx", sdkmath.NewInt(99*USDX_CF)), sdk.NewCoin("busd", sdkmath.NewInt(100*BUSD_CF))),
			},
			expected: []expected{
				{
				...
				{
					expectedAccountBalance: sdk.NewCoins(
						sdk.NewCoin("ugrbc", sdkmath.NewInt(51*KAVA_CF)), // now should be 1 ugrbc more
					...
					expectedModAccountBalance: sdk.NewCoins(
						sdk.NewCoin("ugrbc", sdkmath.NewInt(1049*KAVA_CF)), // now should be 1 ugrbc less
			...
			borrows: []borrowArgs{
				...
				{
					borrowCoins: sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(1*KAVA_CF))),
					wantErr:     "",
				},
			},
		},
	...
	for _, tc := range testCases {
		suite.Run(tc.name, func() {
			...
			authGS := app.NewFundedGenStateWithCoins(
				...
				[]sdk.Coins{
					sdk.NewCoins(
						sdk.NewCoin("ugrbc", sdkmath.NewInt(100*KAVA_CF)),
						sdk.NewCoin("btcb", sdkmath.NewInt(100*BTCB_CF)),
			...
			hardMaccCoins := sdk.NewCoins(
				sdk.NewCoin("ugrbc", sdkmath.NewInt(1000*KAVA_CF)),
...
func (suite *KeeperTestSuite) TestValidateBorrow() {
	...
	initialBorrowCoins := sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(70*KAVA_CF)))
	...
	repayCoins := sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(100*KAVA_CF))) // repay everything including accumulated interest
	...
	err = suite.keeper.Borrow(
		suite.ctx,
		borrower,
		sdk.NewCoins(sdk.NewCoin("ugrbc", availableToBorrow.AmountOf("ugrbc").Add(sdk.OneInt()))),
	)
	suite.Require().Error(err)
	...
	err = suite.keeper.Borrow(
		suite.ctx,
		borrower,
		sdk.NewCoins(sdk.NewCoin("ugrbc", availableToBorrow.AmountOf("ugrbc"))),
	)
	suite.Require().NoError(err)
	...
	err = suite.keeper.Borrow(
		suite.ctx,
		borrower,
		sdk.NewCoins(sdk.NewCoin("ugrbc", sdkmath.NewInt(2*USDX_CF))),
	)
	suite.Require().Error(err)
	...
	// Should error since ugrbc has become insolvent at this point
	err = suite.keeper.Borrow(
		suite.ctx,
		borrower,
		sdk.NewCoins(sdk.NewCoin("ugrbc", availableToBorrow.AmountOf("ugrbc"))),
	...
	}{
		{
			...
			args: args{
				...
				filterByCoins: sdk.NewCoins(
					...
					sdk.NewCoin("ugrbc", sdkmath.NewInt(25*KAVA_CF)),
				),
			},
			want: sdk.NewCoins(
				sdk.NewCoin("usdx", sdkmath.NewInt(200*USDX_CF)),
