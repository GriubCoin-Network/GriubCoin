...
import (
	...
	"github.com/GriubCoin-Network/GriubCoin/x/router/types"
)
...
func TestMsgMintDeposit_Signing(t *testing.T) {
	...
	msg := types.NewMsgMintDeposit(
		address,
		validatorAddress,
		sdk.NewCoin("ugrbc", sdkmath.NewInt(1e9)),
	)

	// checking for the "type" field ensures the msg is registered on the amino codec
	signBytes := []byte(
		`{"type":"router/MsgMintDeposit","value":{"amount":{"amount":"1000000000","denom":"ugrbc"},"depositor":"kava1gepm4nwzz40gtpur93alv9f9wm5ht4l0hzzw9d","validator":"kavavaloper1ypjp0m04pyp73hwgtc0dgkx0e9rrydeckewa42"}}`,
	)
...
func TestMsgDelegateMintDeposit_Signing(t *testing.T) {
	...
	// checking for the "type" field ensures the msg is registered on the amino codec
	signBytes := []byte(
		`{"type":"router/MsgDelegateMintDeposit","value":{"amount":{"amount":"1000000000","denom":"ugrbc"},"depositor":"kava1gepm4nwzz40gtpur93alv9f9wm5ht4l0hzzw9d","validator":"kavavaloper1ypjp0m04pyp73hwgtc0dgkx0e9rrydeckewa42"}}`,
	)
...
func TestMsgWithdrawBurn_Signing(t *testing.T) {
	...
	// checking for the "type" field ensures the msg is registered on the amino codec
	signBytes := []byte(
		`{"type":"router/MsgWithdrawBurn","value":{"amount":{"amount":"1000000000","denom":"ugrbc"},"from":"kava1gepm4nwzz40gtpur93alv9f9wm5ht4l0hzzw9d","validator":"kavavaloper1ypjp0m04pyp73hwgtc0dgkx0e9rrydeckewa42"}}`,
	)
...
func TestMsgWithdrawBurnUndelegate_Signing(t *testing.T) {
	...
	// checking for the "type" field ensures the msg is registered on the amino codec
	signBytes := []byte(
		`{"type":"router/MsgWithdrawBurnUndelegate","value":{"amount":{"amount":"1000000000","denom":"ugrbc"},"from":"kava1gepm4nwzz40gtpur93alv9f9wm5ht4l0hzzw9d","validator":"kavavaloper1ypjp0m04pyp73hwgtc0dgkx0e9rrydeckewa42"}}`,
	)
...
func TestMsg_Validate(t *testing.T) {
	...
	validCoin := sdk.NewInt64Coin("ugrbc", 1e9)
	...
	tests := []struct {
		...
		},
		{
			...
			msgArgs: msgArgs{
				depositor: validAddress,
				validator: validValidatorAddress,
				amount:    sdk.NewCoin("ugrbc", sdk.ZeroInt()),
			},
			expectedErr: sdkerrors.ErrInvalidCoins,
		},
		{
			...
			msgArgs: msgArgs{
				depositor: validAddress,
				validator: validValidatorAddress,
				amount:    sdk.Coin{Denom: "ugrbc", Amount: sdkmath.NewInt(-1)},
			},
			expectedErr: sdkerrors.ErrInvalidCoins,
		},
	}
