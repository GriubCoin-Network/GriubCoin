...
func (suite *GenesisTestSuite) TestInitGenesis() {
	tests := []struct {
		...
		},
		{
			...
			"module account balance does not match sum of fractional balances and remainder, balance is 0ugrbc but expected 2000000000000agrbc (2ugrbc)",
		},
		{
			...
			"module account balance does not match sum of fractional balances and remainder, balance is 100ugrbc but expected 2000000000000agrbc (2ugrbc)",
		},
		{
			"sets module account",
			func() {
