...
// fractional denoms. These assets, e.g. agrbc, should only exist in the
// x/precisebank module as this is a decimal extension of ugrbc that shares
// the same total supply and is effectively the same asset. ugrbc held by this
// module in x/bank backs all fractional balances in x/precisebank. If agrbc
