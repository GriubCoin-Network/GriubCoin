...
func (suite *invariantsIntegrationTestSuite) TestReserveBackingFractionalInvariant() {
	tests := []struct {
		...
		},
		{
			...
			true,
			"precisebank: module reserve backing total fractional balances invariant\nagrbc reserve balance 0 mismatches 500000000000 (fractional balances 0 + remainder 500000000000)\n\n",
		},
		{
			...
			true,
			"precisebank: module reserve backing total fractional balances invariant\nagrbc reserve balance 1000000000000 mismatches 2000000000000 (fractional balances 1500000000000 + remainder 500000000000)\n\n",
		},
		{
			...
			true,
			"precisebank: module reserve backing total fractional balances invariant\nagrbc reserve balance 3000000000000 mismatches 2000000000000 (fractional balances 1500000000000 + remainder 500000000000)\n\n",
		},
	}
