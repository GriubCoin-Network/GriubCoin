	...
	testCases := []struct {
	...
	}{
		{
			...
			proposal: proposalData{
				...
				Amount:      sdk.NewCoins(sdk.NewInt64Coin("ugrbc", 1e10)),
			},
			expectedErr: "",
		},
		{
		...
		},
		{
			...
			proposal: proposalData{
				...
				Amount:      sdk.NewCoins(sdk.NewCoin("ugrbc", sdk.ZeroInt())),
			},
			expectedErr: "invalid coins",
		},
	}
...
func TestCommunityPoolLendDepositProposal_Stringer(t *testing.T) {
	proposal := types.NewCommunityPoolLendDepositProposal(
		"Title",
		"Description",
		sdk.NewCoins(sdk.NewInt64Coin("ugrbc", 42)),
	)
	...
	testCases := []struct {
	...
	}{
		{
			...
			proposal: proposalData{
				...
				Payment:        sdk.NewInt64Coin("ugrbc", 1e6),
			},
			expectedErr: "",
		},
		{
		...
		},
		{
			...
			proposal: proposalData{
				...
				Description:    "My coins are zero",
				CollateralType: "type-a",
				Payment:        sdk.NewInt64Coin("ugrbc", 0),
			},
			expectedErr: "invalid coins",
		},
	}
	...
	testCases := []struct {
	...
	}{
		{
			...
			proposal: proposalData{
				...
				Description:    "I interact with cdp",
				CollateralType: "type-a",
				Collateral:     sdk.NewInt64Coin("ugrbc", 1e6),
			},
			expectedErr: "",
		},
		{
		...
		},
		{
			...
			proposal: proposalData{
				...
				Description:    "My coins are zero",
				CollateralType: "type-a",
				Collateral:     sdk.NewInt64Coin("ugrbc", 0),
			},
			expectedErr: "invalid coins",
		},
	}
