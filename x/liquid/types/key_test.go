...
func TestParseLiquidStakingTokenDenom(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:        "invalid prefix",
			giveDenom:   "ugrbc-kavavaloper1ze7y9qwdddejmy7jlw4cymqqlt2wh05y6cpt5a",
			wantAddress: mustValAddressFromBech32("kavavaloper1ze7y9qwdddejmy7jlw4cymqqlt2wh05y6cpt5a"),
			wantErr:     fmt.Errorf("invalid denom prefix, expected %s, got %s", types.DefaultDerivativeDenom, "ugrbc"),
		},
		{
