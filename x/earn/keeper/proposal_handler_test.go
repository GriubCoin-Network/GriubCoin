...
func (suite *proposalTestSuite) TestCommunityDepositProposal() {
	...
	fundAmount := sdk.NewCoins(sdk.NewInt64Coin("ugrbc", 100000000))
	depositAmount := sdk.NewCoin("ugrbc", sdkmath.NewInt(10000000))
	...
	suite.CreateVault("ugrbc", types.StrategyTypes{types.STRATEGY_TYPE_SAVINGS}, false, nil)
