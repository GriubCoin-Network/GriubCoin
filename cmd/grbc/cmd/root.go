...
import (
	...
	"github.com/GriubCoin-Network/GriubCoin/app/params"
	"github.com/GriubCoin-Network/GriubCoin/cmd/grbc/cmd/iavlviewer"
	"github.com/GriubCoin-Network/GriubCoin/cmd/grbc/cmd/rocksdb"
)

// EnvPrefix is the prefix environment variables must have to configure the app.
const EnvPrefix = "GRBC"
...
func NewRootCmd() *cobra.Command {
	...
	rootCmd := &cobra.Command{
		Use:   "grbc",
		Short: "Daemon and CLI for the GriubCoin blockchain.",
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			customAppTemplate, customAppConfig := servercfg.AppConfig("ugrbc")
